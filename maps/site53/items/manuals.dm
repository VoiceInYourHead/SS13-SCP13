...
<b>Description:</b> SCP-013 is the collective designation of 242 cigarettes which display similar anomalies. The most common external detail between instances is the presence of the words УBlue LadyФ hand-written on each cigarette in blue ink.
...
<b>Special Containment Procedures:</b> SCP-999 is allowed to freely roam the facility should it desire to, but otherwise must stay in its pen. Subject is not allowed out of its pen at night or off facility grounds at any time. Pen is to be kept clean and food replaced twice daily. All personnel are allowed inside SCP-999Тs holding area, but only if they are not assigned to other tasks at the time, or if they are on break. Subject is to be played with when bored and spoken to in a calm, non-threatening tone. <br>

<b>Description:</b> SCP-999 appears to be a large, amorphous, gelatinous mass of translucent orange slime, weighing about 54 kg (120 lbs) with a consistency similar to that of peanut butter. SubjectТs size and shape constantly change, though most of the time its form is the size of a large beanbag chair. Composition of SCP-999 is oil-based, but consists of a substance unknown to modern science. Other than a thin, transparent membrane surrounding the orange mass, subject appears to have no organs to speak of.<br>

SubjectТs temperament is best described as playful and dog-like: when approached, SCP-999 will react with overwhelming elation, slithering over to the nearest person and leaping upon them, УhuggingФ them with a pair of pseudopods while nuzzling the personТs face with a third pseudopod, all the while emitting high-pitched gurgling and cooing noises. The surface of SCP-999 emits a pleasing odor that differs with whomever it is interacting with. Recorded scents include chocolate, fresh laundry, bacon, roses, and Play-DohЩ.

Simply touching SCP-999Тs surface causes an immediate euphoria, which intensifies the longer one is exposed to SCP-999, and lasts long after separation from the creature. SubjectТs favorite activity is tickle-wrestling, often by completely enveloping a person from the neck down and tickling them until asked to stop (though it does not always comply with this request).

While the creature will interact with anyone, it seems to have a special interest in those who are unhappy or hurt in any way. Persons suffering from crippling depression, after interacting with SCP-999, have returned completely cured with a very positive outlook on life. The possibility of marketing SCP-999Тs slime as an antidepressant has been discussed.

In addition to its playful behavior, SCP-999 seems to love all animals (especially humans), refusing to eat any meat and even risking its own life to save others, on one occasion leaping in front of a person to take a bullet fired at them (subjectТs intellect is still up for debate: though its behavior is infantile, it seems to understand human speech and most modern technology, including guns). The creatureТs diet consists entirely of candy and sweets, with M&MТsЩ and NeccoЩ wafers being its favorites. Its eating methods are similar to those of an amoeba.
<br>
<b>Addendum SCP-999-A:</b> The following is a report from an experiment in which SCP-682 is exposed to SCP-999 in the hopes that it will curb the creatureТs omnicidal rage.
<br><br>
<i>
SCP-999 is released into SCP-682Тs containment area. SCP-999 immediately slithers towards SCP-682.
<br>
999: (elated gurgles)
<br>
...
<br>
682: (grunts) Hmmm? (unintelligible) what is thisЕ (low noise, similar to light chuckle) I feel allЕ tingly insideЕ
<br>
SCP-999 can be seen crawling up from between SCP-682Тs toes, up along its side and around its neck, where it clings on and begins gently nuzzling with its pseudopod. A wide grin slowly spreads across SCP-682Тs face.
<br>
682: (deep chuckling) I feelЕ soЕ happy. HappyЕ (laughs) happyЕ happyЕ
<br>
SCP-682 repeats the word УhappyФ for several minutes, laughing occasionally before escalating into nonstop laughter. As laughter continues, SCP-682 rolls around on its back, slamming its tail upon the floor with dangerous force.
<br>
682: (bellowing laughter) Stop! No tickling! (continues laughing)
<br>
SCP-682 and SCP-999 continue the Уtickle fightФ until SCP-682 finally wears down and appears to fall asleep with what would appear to be a smile on its face. After fifteen minutes with no activity, two D-Class personnel enter the room to retrieve SCP-999. When SCP-999 is removed, SCP-682 immediately wakes up and unleashes an unidentifiable wave of energy from its body, all the while laughing maniacally.
<br>
All persons within the waveТs range collapse into crippling fits of laughter, allowing SCP-682 to escape and slaughter all in its path. Meanwhile, SCP-999 quickly rescues as many persons as it can, taking them to a safe place to recover from SCP-682Тs "laughter wave" while agents suppress and recontain SCP-682.
<br>
Despite the tragedy that SCP-682 had brought upon the facility, SCP-999 has not shown any fear towards the creature and in fact has made gestures suggesting it wants to УplayФ with SCP-682 again. SCP-682, however, has stated, УThat feculent little snot wad can -DATA EXPUNGED- and die."</i>
...
/obj/item/weapon/paper/scp/euclid/scp049
	name = "SCP-049"
	info = {"
	<tt><center><b><font color='orange'>SCP-049 - "„умной ƒоктор"</font></b>
	<h3>Ќј”„Ќјя —Ћ”∆Ѕј</h3>
	</center>
<br>
<b>ќбъект є:</b> SCP-049
<br>
<b> ласс объекта:</b> ≈вклид
<br>
<b>ќсобые услови€ содержани€:</b> SCP-049 должен содержатьс€ в охран€емой камере »сследовательского ”частка 53. SCP-049 нельз€ извлекать из камеры без разрешени€ сотрудников уровн€ два или выше; перед изъ€тием объект необходимо подвергнуть воздействию сильных транквилизаторов.

 роме этого, его должны сопровождать два (2) вооружЄнных охранника, на нЄм должен быть надет стальной ошейник с двум€ присоединЄнными стальными трубами длиной 2 м, которые должны крепко держать два (2) сотрудника службы безопасности 1 или более высокого уровн€ допуска в течение всего времени транспортировки.

Ћюбые эксперименты над SCP-049 должны проводитьс€ в помещени€х, подготовленных особым образом (см. документ 042-D-3-18).

 амера SCP-049 должна посто€нно просматриватьс€ с помощью видеокамер. ѕри про€влении объектом любого аномального поведени€ следует сразу же оповестить д-ра ------
<br>
<b>ќписание:</b> SCP-049 имеет гуманоидную внешность, рост 1,9 м и вес 95,3 кг. “ем не менее, на данный момент невозможно изучить его лицо и тело более подробно, так как объект покрыт тем, что выгл€дит как традиционный костюм Ђчумного доктораї ≈вропы XV-XVI вв. Ётот материал фактически €вл€етс€ частью тела SCP-049; как показало генетическое исследование и анализ с помощью микроскопа, его структура аналогична мышечной ткани, хот€ на ощупь он больше похож на грубую кожу, а маска напоминает керамическую.

SCP-049 был обнаружен местной полицией в ------, јнгли€. ћобильна€ оперативна€ группа среагировала на возможное по€вление ------. ќдним из этапов начальной процедуры содержани€ стало введение всем гражданским лицам в радиусе 500 метров амнезиака класса A.

ѕрикосновение SCP-049 всегда смертельно дл€ людей. ѕосле контакта с рукой (руками) объекта жертва (здесь и далее обозначаетс€ как SCP-049-2) испытывает ------ и через несколько мгновений умирает. «атем SCP-049 пытаетс€ убить всех людей в пределах видимости тем же способом - предположительно дл€ того, чтобы его не отвлекали - после чего возвращаетс€ к SCP-049-2. ќткуда-то изнутри тела он достаЄт сумку (исследовани€ не смогли определить еЄ местоположение в теле SCP-049 при помощи рентгена и подобных методик), сделанную из ------, содержащую скальпели, иглу, нить и несколько колб с пока не изученными веществами, и начинает препарировать SCP-049-2, а также внедр€ть в тело различные химические препараты. ѕримерно через 20 минут SCP-049 зашивает SCP-049-2 и снова становитс€ контролируемым.

„ерез несколько минут SCP-049-2 про€вл€ет признаки жизни и начинает оживать. “ем не менее, SCP-049-2 выгл€дит абсолютно лишЄнным высших мозговых функций; он будет бесцельно бродить до тех пор, пока не обнаружит другого живого человека. ¬ этот момент уровни адреналина и эндорфина SCP-049-2 повышаютс€ втрое, он пытаетс€ убить и ------ любое человеческое существо, которое сможет найти, затем возвращаетс€ в бездумное состо€ние и бродит до тех пор, пока снова не встретит людей. Ќа этом этапе дозволено уничтожение любыми способами. ≈сли данную операцию не удалось провести, виновный караетс€ уничтожением (исключение - исследовательские цели, см. ѕриложение T-049-12).

¬скрыти€ тел образцов SCP-049-2 вы€вили наличие нескольких необычных веществ (нар€ду с обычными веществами в больших количествах) внутри тел, включа€ ------. Ќекоторые вещества ещЄ предстоит идентифицировать (сотрудники с 3 или более высоким уровнем допуска могут обратитьс€ к ѕриложению C-1).
"}
...
SCP-513 was recovered by Agent ¶¶¶¶¶¶ while carrying out Containment Reestablishment Procedure Mu at Site-¶¶. SCP-513Тs clapper was firmly held in place by several strips of duct tape. A single scrap of paper was found along with SCP-513 (see Addendum).
...
Sightings of SCP-513-1 reoccur every 14 to 237 minutes. This УstalkingФ behavior inevitably causes extreme sleep deprivation, as victims are frequently disturbed by SCP-513-1Тs presence in their quarters. Victims able to fall asleep before SCP-513-1's appearance report being physically assaulted by it. Upon the victim's awakening, SCP-513-1 flees as usual (see Experiment Log 513). This sleep deprivation, along with the mental stress caused by SCP-513-1's behavior, invariably induces paranoia, aggression, hypervigilance, and depression. All test cases but one have ended with the test subjectТs suicide.
...
<b>Capt. ¶¶¶¶¶¶¶¶¶:</b> *Pauses* You know, after hearing that thing's screams, and the screams of my men, I don't think I want to put a face to what I heard. No. JustЕ no.
...
YouТve seen it. Now he can hear you.<br>
YouТve touched it. Now he can see you.<br>
...
Secondary containment area is to be comprised of sixteen spherical УcellsФ, each filled with various fluids and a random assembly of surfaces and supports. Secondary containment is to be fitted with light systems, capable of flooding the entire assembly with no less than 80,000 lumens of light instantly with no direct human involvement. Both containment areas are to remain under 24 hour surveillance.
...
<br>
Note: Continued research and observation have shown that, when faced with highly complex/random assemblies of structures, SCP-106 can be УconfusedФ, showing a marked delay on entry and exit from said structure. SCP-106 has also shown an aversion to direct, sudden light. This is not manifested in any form of physical damage, but a rapid exit in to the Уpocket dimensionФ generated on solid surfaces.

These observations, along with those of lead-aversion and liquid confusion, have reduced the general escape incidents by 43%. The УprimaryФ cells have also been effective in recovery incidents requiring Recall Protocol ¶¶ -¶¶¶ -¶. Observation is ongoing.
<br>
Description: SCP-106 appears to be an elderly humanoid, with a general appearance of advanced decomposition. This appearance may vary, but the УrottingФ quality is observed in all forms. SCP-106 is not exceptionally agile, and will remain motionless for days at a time, waiting for prey. SCP-106 is also capable of scaling any vertical surface and can remain suspended upside down indefinitely. When attacking, SCP-106 will attempt to incapacitate prey by damaging major organs, muscle groups, or tendons, then pull disabled prey into its pocket dimension. SCP-106 appears to prefer human prey items in the 10-25 years of age bracket.

SCP-106 causes a УcorrosionФ effect in all solid matter it touches, engaging a physical breakdown in materials several seconds after contact. This is observed as rusting, rotting, and cracking of materials, and the creation of a black, mucus-like substance similar to the material coating SCP-106. This effect is particularly detrimental to living tissues, and is assumed to be a Уpre-digestionФ action. Corrosion continues for six hours after contact, after which the effect appears to Уburn outФ.

SCP-106 is capable of passing through solid matter, leaving behind a large patch of its corrosive mucus. SCP-106 is able to УvanishФ inside solid matter, entering what is assumed to be a form of Уpocket dimensionФ. SCP-106 is then able to exit this dimension from any point connected to the initial entry point (examples: УenteringФ the inner wall of a room, and УexitingФ the outer wall. Entering a wall, and exiting from the ceiling). It is unknown if this is the point of origin for SCP-106, or a simple УlairФ created by SCP-106.

Limited observation of this Уpocket dimensionФ has shown it to be comprised mostly of halls and rooms, with -DATA EXPUNGED- entry. This activity can continue for days, with some subjected individuals being released for the express purpose of hunting, recapture, -DATA EXPUNGED-.
"}
