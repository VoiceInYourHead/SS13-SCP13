...
/obj/item/toy/figure/scp/security
	...
	desc = "A \"Dr. Razvlechudov\" brand security action figure. There is some kind of stats on the bottom...Alexey Golubev, HP:100, Range Weapon: M16(Damage:20, Range: 15 tiles), Melee Weapon: Combat Knife(Damage:10)"
	icon_state = "scp_sec"
